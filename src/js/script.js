    ...
    script.app = { 
        ...
        init: function(){
            ...
            $("select[select]").each(function () {
                ...
                script.app.utility.multiSelect($(this));
                setTimeout(() => {

                    $(".top_filter").removeClass("d-none");
        ...
        utility: {
            ...
            multiSelect: function (element) {
                element.multiselect({
                    ...
                    nonSelectedText: element.data("nonselected-text") != undefined ? element.data("nonselected-text") : null,
                    filterPlaceholder: element.data("search-placeholder") != undefined ? element.data("search-placeholder") : null,
                    numberDisplayed: 1,
                    templates: {
                            button: '<button type="button" class="multiselect" data-bs-toggle="dropdown"><span class="multiselect-selected-text"></span></button>',
